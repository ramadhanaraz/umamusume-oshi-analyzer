...
export const HeroArchetype: React.FC<HeroArchetypeProps> = ({
  ...
  return (
    <div
      className={`rounded-3xl bg-gradient-to-r ${archetype.gradient} p-6 sm:p-8 shadow-2xl relative overflow-hidden text-white flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border ${archetype.border} transition-all duration-500 select-none`}
    >
      {/* Left Column: Badge, Title, Description & Strategy */}
      <div className="space-y-3.5 max-w-2xl">
        {/* Yellow Capitalized Pill Badge */}
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-black/30 backdrop-blur-md text-amber-200 text-xs font-bold uppercase tracking-widest border border-white/10 shadow-sm">
      ...
      {/* Right Column: Frosted Glass Counter Card */}
      <div className="w-full md:w-auto shrink-0 bg-black/25 backdrop-blur-md rounded-2xl p-5 sm:p-6 border border-white/15 flex flex-col items-center justify-center min-w-[210px] text-center shadow-xl">
